...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="main">
		<div class="action">
						...
						<div class="pages">
						<s:form name="searchForm" action="findMail" namespace="/mail">
							...
							<s:iterator value="pager.pageRecords">
							 ...
							 <s:else>
							   <tr height="30px">
							      ...
							      <td><a href="javascript:void(0);" class="delete" id="<s:property value="id"/>">删除</a></td>
								</tr>
...
$(function(){
  $(".emailInfo").click(function(){
       var id = $(this).attr("id");
        window.location.href="${ctx}/mail/mailInfo.action?mail.id="+id;
...
$(function(){
   ...
   $(".delete").click(function() {
        ...
        {"mail.to_uid":uid,
         ...
         function(data){ 
        if(data.retcode=="0"){
        window.location.href="${ctx}/mail/findMail.action?mail.to_uid="+uid+"&mail.toStatu="+ts;
        }else{
          alert(data.retmsg);
        }
      }
